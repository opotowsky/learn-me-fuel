...
def main():
    """
    Given training data, this script performs the generation of validation
    curves for three algorithms: knn, decision trees, support vectors.
    Validation curves provide the prediction score/accuracy with respect to
    some algoritm hyperparameter
